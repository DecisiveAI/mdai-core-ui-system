...
<div class="mdai-card-container">
  <SMUICard style={style}>
    ...
    <div class="mdai-card-actions">
      ...
      <Button variant='Outlined' label={buttonLabels[0]} disabled={buttonDisabled} handleClick={buttonsOnClick[0]?.()}></Button>
      <Button variant='Filled' label={buttonLabels[1]} disabled={buttonDisabled} handleClick={buttonsOnClick[1]?.()}></Button>
      {:else}
      <Button variant='Filled' label={buttonLabels} disabled={buttonDisabled} handleClick={buttonsOnClick[0]?.()}></Button>
      {/if}
    </div>
  </PrimaryAction>
  </SMUICard>
